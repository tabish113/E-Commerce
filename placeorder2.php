...
<form  method="POST" id="reg_form1">
            <div class="row" id="ijhi">
                ...
                <div class="form-group label-floating is-empty">
                  ...
                  <input type="text" class="form-control" id="nm" name="nm" placeholder="Name"   required>
                </div>
              </div>
...
<center>
      ...
      <input type="button"   id="colorred" onClick="place();"  style=" color:#000; border-color:gray;"  name="change_pass"   class="btn btn-primary btn-lg full-width" value="Cash On Delivery">
              </div>
              </center>
                </div>
           </form>
 ...
 document.getElementById("colorred").style.backgroundColor = "red";
    document.getElementById("colorred").style.color = "#fff";
         ...
         $.ajax({
          ...
          method:"POST",
          data:{add:add,no:no,nm:nm,ps:ps,cps:cps,pin:pin},
