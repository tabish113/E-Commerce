...
<head>
  ...
  <link rel="shortcut icon" href="cdn.shopify.com/s/files/1/1485/6894/files/favicon_32x32e686.png?v=1519211374" type="image/png">
  

  
  <title>
 HOUSEHOLD PLANTS OXYGEN CREDIT
  </title>
...
<link rel="stylesheet" media="screen" href="../cdn.shopify.com/s/files/1/1485/6894/t/3/compiled_assets/styles5419.css?9965371921026575025">
    ...
    <div class="container container-ver2 product-v2 product-v3">
      <div class="row">    
        <div class="title">
          ...
          <h3>Household Plants Oxygen Credit</h3>
        </div>
        <div class="group-product clearfix">
          
          
<?php
$select="SELECT * FROM product WHERE cat='HOUSEHOLD'";
  ...
  <div class="item-inner">
    <div class="product">
      ...
      <div class="info-product">
       <center> <a href="product_view.php?id=<?php echo $id;?>" title="House Shape Close"><p class="product-title"><?php echo $nm;?> <b style="color:red;">2Pc</b></p></a>            
